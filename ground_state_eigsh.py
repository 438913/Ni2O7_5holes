...
#                    ", weight = ", weight,'\n')  
            ...
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.Ni_orbs) and (orb4 in pam.Ni_orbs) and (orb5 in pam.O_orbs) and x1==x2==0 and x3==x4==2 and ((abs(x5-0) + abs(y5-0))==1 and (x5,y5)!=(1,0)):
            ...
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.Ni_orbs) and (orb4 in pam.Ni_orbs) and (orb5 in pam.O_orbs) and x1==x2==0 and x3==x4==2  and ((abs(x5-2) + abs(y5-0))==1 and (x5,y5)!=(1,0)):
            ...
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.Ni_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==0 and x2==x3==2 and ((abs(x4-0) + abs(y4-0))==1) and ((abs(x5-2) + abs(y5-0))==1 and (x4,y4)!=(1,0) and (x5,y5)!=(1,0)): 
            ...
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.Ni_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==x2==0 and x3==2 and ((abs(x4-0) + abs(y4-0))==1) and ((abs(x5-2) + abs(y5-0))==1 and (x4,y4)!=(1,0) and (x5,y5)!=(1,0)): 
            ...
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.Ni_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==0 and x2==x3==2 and ((abs(x4-0) + abs(y4-0))==1) and ((abs(x5-0) + abs(y5-0))==1) and (x4, y4) != (1, 0) and (x5, y5) != (1, 0):
            ...
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.Ni_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==x2==0 and x3==2 and ((abs(x4-2) + abs(y4-0))==1 ) and ((abs(x5-2) + abs(y5-0))==1): 
            ...
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.Ni_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==0 and x2==x3==2 and ((abs(x4-2) + abs(y4-0))==1 and (x4,y4)!=(1,0)) and ((abs(x5-2) + abs(y5-0))==1 and (x5,y5)!=(1,0)): 
                wgt_d9d8L2[0]+=abs(vecs[istate,k])**2                 

            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==0 and x2==2 and ((abs(x3-2) + abs(y3-0))==1 and (x3,y3)!=(1,0)) and ((abs(x4-2) + abs(y4-0))==1 and (x4,y4)!=(1,0)) and ((abs(x5-2) + abs(y5-0))==1 and (x5,y5)!=(1,0)): 
                wgt_d9d9L3[0]+=abs(vecs[istate,k])**2  
                
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==0 and x2==2 and ((abs(x3-0) + abs(y3-0))==1) and ((abs(x4-2) + abs(y4-0))==1 and (x4,y4)!=(1,0)) and ((abs(x5-2) + abs(y5-0))==1 and (x5,y5)!=(1,0)):  
            ...
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==0 and x2==2 and ((abs(x3-0) + abs(y3-0))==1) and ((abs(x4-0) + abs(y4-0))==1) and ((abs(x5-2) + abs(y5-0))==1 and (x5,y5)!=(1,0)):  
            ...
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==0 and x2==2 and ((abs(x3-0) + abs(y3-0))==1) and ((abs(x4-0) + abs(y4-0))==1) and ((abs(x5-2) + abs(y5-0))==1):  
                wgt_d9L3d9[0]+=abs(vecs[istate,k])**2                  

            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==x2==0 and ((abs(x3-2) + abs(y3-0))==1 and (x3,y3)!=(1,0)) and ((abs(x4-2) + abs(y4-0))==1 and (x4,y4)!=(1,0)) and ((abs(x5-2) + abs(y5-0))==1 and (x5,y5)!=(1,0)): 
                wgt_d8d10L3[0]+=abs(vecs[istate,k])**2  
                
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==x2==0 and ((abs(x3-0) + abs(y3-0))==1) and ((abs(x4-2) + abs(y4-0))==1 and (x4,y4)!=(1,0)) and ((abs(x5-2) + abs(y5-0))==1 and (x5,y5)!=(1,0)): 
                wgt_d8Ld10L2[0]+=abs(vecs[istate,k])**2                  
                
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==x2==0 and ((abs(x3-0) + abs(y3-0))==1 ) and ((abs(x4-0) + abs(y4-0))==1) and ((abs(x5-2) + abs(y5-0))==1 and (x5,y5)!=(1,0)): 
                wgt_d8L2d10L[0]+=abs(vecs[istate,k])**2                   
                
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.Ni_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==0 and x2==0 and ((abs(x3-0) + abs(y3-0))==1) and ((abs(x4-0) + abs(y4-0))==1) and ((abs(x5-2) + abs(y5-0))==1):  
                wgt_d8L3d10[0]+=abs(vecs[istate,k])**2                  
                
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.O_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==0 and ((abs(x2-2) + abs(y2-0))==1 and (x2,y2)!=(1,0)) and ((abs(x3-2) + abs(y3-0))==1 and (x3,y3)!=(1,0)) and ((abs(x4-2) + abs(y4-0))==1 and (x4,y4)!=(1,0)) and ((abs(x5-2) + abs(y5-0))==1 and (x5,y5)!=(1,0)): 
                wgt_d9d10L4[0]+=abs(vecs[istate,k])**2                     
                    
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.O_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==0 and ((abs(x2-0) + abs(y2-0))==1) and ((abs(x3-2) + abs(y3-0))==1 and (x3,y3)!=(1,0)) and ((abs(x4-2) + abs(y4-0))==1 and (x4,y4)!=(1,0)) and ((abs(x5-2) + abs(y5-0))==1 and (x5,y5)!=(1,0)): 
                wgt_d9Ld10L3[0]+=abs(vecs[istate,k])**2                        
                    
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.O_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==0 and ((abs(x2-0) + abs(y2-0))==1) and ((abs(x3-0) + abs(y3-0))==1) and ((abs(x4-2) + abs(y4-0))==1 and (x4,y4)!=(1,0)) and ((abs(x5-2) + abs(y5-0))==1 and (x5,y5)!=(1,0)): 
                wgt_d9L2d10L2[0]+=abs(vecs[istate,k])**2                        
                    
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.O_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==0 and ((abs(x2-0) + abs(y2-0))==1) and ((abs(x3-0) + abs(y3-0))==1 ) and ((abs(x4-0) + abs(y4-0))==1) and ((abs(x5-2) + abs(y5-0))==1 and (x5,y5)!=(1,0)) : 
                wgt_d9L3d10L[0]+=abs(vecs[istate,k])**2    
                
            elif (orb1 in pam.Ni_orbs) and (orb2 in pam.O_orbs) and  (orb3 in pam.O_orbs) and (orb4 in pam.O_orbs) and (orb5 in pam.O_orbs) and x1==0 and ((abs(x2-0) + abs(y2-0))==1 ) and ((abs(x3-0) + abs(y3-0))==1) and ((abs(x4-0) + abs(y4-0))==1) and ((abs(x5-0) + abs(y5-0))==1):
