...
def state_classification(state):
    ...
    :param state: state = [(orb1, x1, y1), (orb2, x2, y2), (orb3, x3, y3), (orb4, x4, y4), (orb5, x5, y5)]
    :return: state_type: string, e.g. 'L0_d10_L_d9_L3',
    means 0 hole in left O, 0 hole in Ni(-1, 0), 0 hole in middle O(0, 0), 1 hole in Ni(1, 0), 0 hole in right O
    """
    num_in_left_O = 0
    num_in_middle_O = 0
    num_in_right_O = 0
    ...
    for (orb, x, y) in state:
        ...
        if orb in pam.O_orbs:
            ...
            if (x, y) in [(2, 0), (1, 1), (1, -1)]:
                num_in_right_O += 1
    O_num_to_str = {0: 'L0', 1: 'L', 2: 'L2', 3: 'L3', 4: 'L4'}
    ...
    if num_in_left_Ni == 0 and num_in_right_Ni == 0:
        ...
        state_type = (f'{O_num_to_str[num_in_left_O]}_{Ni_num_to_str[num_in_left_Ni]}'
                      f'_{O_num_to_str[num_in_middle_O]}'
                      f'_{Ni_num_to_str[num_in_right_Ni]}_{O_num_to_str[num_in_right_O]}')
    return state_type
...
#             print (slabel)
           ...
           # 修改过的代码
            state = [(orb1, x1, y1), (orb2, x2, y2), (orb3, x3, y3), (orb4, x4, y4), (orb5, x5, y5)]
            state_type_key = state_classification(state)
...
#                     wgt_dddds[5]+=abs(vecs[istate,k])**2
    ...
    print(f'pressure = {pam.pressure} Gpa')
#         print ('s11=',s11)
#         print ('s10=',s10)
#         print ('s01=',s01)
#         print ('s00=',s00)
